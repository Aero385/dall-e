  ...
  return (
    <div className='rounded-xl group relative shadow-card hover:shadow-cardhover card'>
       <img
         ...
         alt={prompt}
       />
       <div className='group-hover:flex flex-col hidden absolute bottom-0 left-0 bg-[#10131f] right-0 max-h-[94.5%] m-2 p-4 rounded-md'>
         ...
         <div className='mt-5 flex justify-between items-center gap-2'>
            ...
            <button
              ...
              className='utline-none bg-transparent border-none'
            >
